...
struct RouletteText: View {
    var body: some View {
        VStack(alignment:.leading){
            RouletteCharacters(text: "To be or", delay: 0.1)
            RouletteCharacters(text: "not to be,", delay: 0.3)
            RouletteCharacters(text: "that is the", delay: 0.5)
          RouletteCharacters(text: "question.", delay: 0.8)
        }
        .padding()
    }
}
